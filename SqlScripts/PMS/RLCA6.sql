IF OBJECT_ID(N'dbo.RLCA6', N'U') IS NULL
BEGIN

Create Table RLCA6 ( ID Bigint 
...
,[POfDemVal] Nvarchar(50)
,[CSensOrdNrepVal] Nvarchar(2)
,[Filler] Nvarchar(20)


 CONSTRAINT [PK_RLCA6] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
